    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-5">
      ...
      <Card className="flex h-[min(760px,calc(100svh-180px))] min-h-[560px] flex-col overflow-hidden rounded-2xl border-black/5 p-0! shadow-sm" styles={{ body: { display: 'flex', minHeight: 0, height: '100%', flexDirection: 'column', padding: 0 } }}>
        <header className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 sm:px-6">
          <div className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-full bg-teal-100 text-teal-700"><SafetyOutlined /></span><div><h3 className="m-0 text-base font-semibold text-slate-800">Trợ lý GastroAI</h3><span className="text-xs text-emerald-600">● Đang hoạt động</span></div></div>
          <Tag color="cyan">Bệnh nhân</Tag>
        </header>

        <div className="flex items-start gap-2 border-b border-amber-200 bg-amber-50 px-4 py-3 text-sm leading-5 text-amber-900 sm:px-6" role="note"><SafetyOutlined className="mt-0.5 shrink-0" /><span><strong>Lưu ý y tế:</strong> Nếu bạn đang gặp trường hợp khẩn cấp, vui lòng gọi cấp cứu 115 hoặc đến cơ sở y tế gần nhất.</span></div>
